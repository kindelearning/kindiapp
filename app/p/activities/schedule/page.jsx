...
import SetNewActivities from "@/app/Sections/Activity/SetNewActivities";
...
export default function Schedule() {
  ...
  return (
    <>
      <NewHeader headerText="Schedule" />
      <section className="w-full h-auto bg-[#EAEAF5] pb-24 items-center justify-center  flex flex-col md:flex-row gap-[20px]">
        <head>
          <title>Schedule | The Kindi</title>
        </head>
