...
function SearchInput({ value, onChange }) {
  return (
    <div className="flex w-full h-[56px] items-center bg-white rounded-full border border-gray-200">
      ...
      <Input
        ...
        value={value}
        onChange={onChange}
        className="w-full border-0 md:h-[56px] border-white py-4 rounded-full focus-visible:outline-none focus-visible:ring-0 focus-visible:ring-offset-0 focus:border-0 focus-within:border-0 px-3 "
      />
    </div>
  );
}
