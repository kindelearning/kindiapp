...
export default function BlogDetailPage({ params }) {
  ...
  return (
    <>
      <NewHeader headerText={Text ? Text : "Blog"} />
      <section className="w-full  -mt-[8px] font-fredoka h-auto py-0 lg:py-12 bg-[#EAEAF5] items-center justify-center pb-24 flex flex-col gap-[20px]">
