...
//       <div className="w-full min-h-[90vh] h-full bg-purple py-12 items-center justify-center flex flex-col gap-[20px]">
...
//                 required
//                 className="rounded-full bg-white ring-offset-0 focus:ring-0 border-0 w-full"
//               />
//               <Input
//                 type="text"
//                 // value={lastName}
...
//                 required
//                 className="rounded-full ring-offset-0 bg-white  focus:ring-0 border-0 w-full"
//               />
//               <Input
//                 type="text"
//                 // value={phone}
            ...
            >
              <div className="flex w-full gap-1">
                <Input
                  ...
                  placeholder="First Name"
                  required
                  className="rounded-full ring-offset-0  bg-whitefocus:ring-0 border-0 w-full"
                />
                <Input
                  type="text"
                  value={lastName}
