          ...
          <div className="flex w-full flex-col gap-2 items-center justify-start">
            <div className="flex w-full flex-col md:flex-row gap-2 md:gap-0 items-center justify-center md:justify-start">
              <Input
                ...
                required
                className="rounded-l-[12px] bg-white focus-visible:ring-0 focus-visible:ring-offset-0 rounded-full md:rounded-r-[0px] ring-offset-0 focus:ring-0 border-0 w-full md:w-[300px]"
              />
              <Button className="px-12 text-center rounded-full md:rounded-l-[0px] text-white hover:border-2 uppercase font-bold text-[16px] hover:border-[#ffffff8a] border-[#ffffff] hover:bg-[#3f3a64] md:px-8 xl:px-12 border-2 bg-red w-full md:w-auto">
                Subscribe
              </Button>
            </div>
          </div>
