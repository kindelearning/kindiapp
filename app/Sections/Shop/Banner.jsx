export default function Banner() {
  return (
    <>
      <section className="w-full claracontainer h-full min-h-[120px] px-4 bg-[#EAEAF5] items-center justify-center py-2 flex flex-col md:flex-row gap-[20px]">
        <div
          style={{
          ...
          className="claracontainer min-w-full min-h-[100px] rounded-xl items-center justify-between lg:min-h-[300px] px-4 md:px-2 lg:px-4 flex flex-row overflow-hidden gap-8"
        >
