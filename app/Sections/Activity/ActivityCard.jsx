  ...
  return (
    <>
      <Link
        href={activityUrl || "#"}
        target="_blank"
        className="md:w-full md:max-w-full   hover:shadow-md duration-200 min-w-[170px] w-full min-h-[250px] h-full bg-white items-start justify-start border rounded-3xl flex flex-col md:flex-row gap-4"
      >
