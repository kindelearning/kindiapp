...
const InternalChip = ({ image, title }) => {
  return (
    <div className="claracontainer liquid-hover cursor-pointer w-full pl-4 bg-white rounded-[26px] flex justify-start gap-[12px] flex-row items-center">
      ...
      />
      <div className="text-black text-[12px] w-full font-medium py-4 pr-4 rounded-r-[24px] hover:text-[white] duration-150 liquid-hover font-montserrat leading-[16px]">
        {title}
      </div>
    </div>
  );
  ...
  return (
    <>
      <section className="w-full h-auto bg-[#523373] items-center justify-center py-4 flex flex-col md:flex-row gap-[20px]">
        ...
        <div className="claracontainer  md:px-0 lg:px-4 px-4 py-12 w-full items-center justify-center flex flex-col-reverse lg:flex-row xl:flex-row overflow-hidden gap-8">
