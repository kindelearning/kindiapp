...
import { BottomNavigation, DynamicCard, Header } from "@/app/Sections";
...
const hygraphClient = new GraphQLClient(process.env.HYGRAPH_MAIN_ENDPOINT, {
  headers: {
    authorization: `Bearer ${process.env.HYGRAPH_MAIN_TOKEN}`, // Add token if needed
  },
});
