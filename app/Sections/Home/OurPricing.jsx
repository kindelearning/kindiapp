...
const PricingCard = ({
  ...
  return (
    <div className="w-full min-w-[300px] md:min-w-[350px] lg:min-w-[300px] max-w-[360px] h-auto bg-[#ffffff] rounded-[32px] items-start justify-center flex flex-col gap-[20px] ">
