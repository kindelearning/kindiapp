...
export default function LocalHeader() {
  ...
  return (
    <header className="sticky rounded-b-[12px] top-0 z-50 w-full px-4 -mb-[20px] bg-red dark:bg-dark-blue-100 shadow-md flex justify-center items-center py-4 md:py-4">
